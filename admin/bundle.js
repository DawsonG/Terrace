...
/***/ function(module, exports, __webpack_require__) {
	...
	// Main Pages
	var Dashboard = __webpack_require__(163);
	  ...
	  render: function() {
	    return (
	      React.createElement("div", null, 
	        "Content", 
	        this.state.title, " - ", this.state.slug, React.createElement("br", null), 
	        this.state.content
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Menu = React.createClass({displayName: "Menu",
	    render: function() {
	        return (React.createElement("div", {className: "ui vertical pointing menu"}, 
	            this.props.children
	        ));
	    }
	});
